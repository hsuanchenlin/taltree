...
- Talent-tree projection, layered layout, and spatial neighbor lookup live in [`src/graph/`](src/graph/). The canvas reads `buildTalentTree`; it must not re-derive kinds or unlocks.
